...
Understood. I've removed the citations and academic references, keeping the focus entirely on your analysis, the results, and the technical implementation.

Here is the clean, copy-paste ready Quarto code for your Income Prediction project.
...
::: {.d-grid .gap-2 .d-md-flex .justify-content-md-start .mb-4}
[<i class="bi bi-github"></i> View on GitHub](https://github.com/anishR24/advanced-data-mining/tree/main/CA2){target="_blank" .btn .btn-outline-dark .btn-sm} 
[<i class="bi bi-database"></i> Dataset](https://archive.ics.uci.edu/dataset/2/adult){target="_blank" .btn .btn-outline-info .btn-sm}
:::
