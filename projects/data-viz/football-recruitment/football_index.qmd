...
[<i class="bi bi-github"></i> View Project on GitHub](https://github.com/anishR24/data-visualisation/tree/main/CA2){target="_blank" .btn .btn-outline-dark .btn-sm}
...
[📄 Download Comparative Report (PDF)](football_scouting.pdf){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
