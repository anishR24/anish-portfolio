...
[<i class="bi bi-file-earmark-pdf"></i> View Comparative Report (PDF)](football_scouting.pdf){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
[<i class="bi bi-file-earmark-code"></i> Download Tableau (.twbx)](football_scouting.twbx){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
[<i class="bi bi-file-earmark-code"></i> Download Power BI (.pbix)](football_scouting.pbix){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}