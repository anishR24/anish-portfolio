...
[<i class="bi bi-github"></i> View Project on GitHub](https://github.com/anishR24/data-visualisation/tree/main/CA1){target="_blank" .btn .btn-outline-dark .btn-sm}

## Dashboard Preview
![Social Progress Index Analysis Dashboard](Dashboard.png){.border .shadow .rounded}

## Interactive Dashboard
Explore the global patterns directly below. Use the "Bottom N" filter to adjust the focal point of the analysis.

[<i class="bi bi-bar-chart-line"></i> View on Tableau Public](https://public.tableau.com/app/profile/anish.rao/viz/B9DA106_CA1_Anish_20066423/FinalDashboard){target="_blank" .btn .btn-outline-primary .btn-sm}
...
[📄 Download Full Analysis Report (PDF)](social_progress_analysis.pdf){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
[📥 Download Tableau Workbook (.twbx)](social_progress_analysis.twbx){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}