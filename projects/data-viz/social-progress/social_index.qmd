...
[<i class="bi bi-github"></i> View Project on GitHub](https://github.com/anishR24/data-visualisation/tree/main/CA1){target="_blank" .btn .btn-outline-dark .btn-sm} [<i class="bi bi-database"></i> Dataset (Kaggle)](https://www.kaggle.com/datasets/samithsachidanandan/social-progress-index-rankings/data){target="_blank" .btn .btn-outline-info .btn-sm}
...
[<i class="bi bi-file-earmark-pdf"></i> View Full Analysis Report (PDF)](social_progress_analysis.pdf){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
[<i class="bi bi-file-earmark-code"></i> Download Tableau Workbook (.twbx)](social_progress_analysis.twbx){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}