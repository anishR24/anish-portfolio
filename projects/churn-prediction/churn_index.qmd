...
::: {layout-ncol=2}
[<i class="bi bi-file-earmark-pdf"></i> View Full Dissertation (PDF)](20066423_Anish_Rao_Report.pdf){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4} [ <i class="bi bi-file-earmark-code"></i> Download Project Files (.zip)](churn_project_files.zip){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
:::