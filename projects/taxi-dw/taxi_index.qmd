...
[<i class="bi bi-github"></i> View Project on GitHub](https://github.com/anishR24/data-storage-solutions-for-data-analytics/tree/main/CA1){target="_blank" .btn .btn-outline-dark .btn-sm}
...
[📄 Download Analysis Report (PDF)](nyc_taxi_dw.pdf){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
[📥 Download Tableau Workbook (.twbx)](nyc_taxi_analytics.twbx){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}