...
:::
::: {layout-ncol=1}
[📥 Download SQL Scripts (.sql)](nyc_taxi_dw.sql){.btn .btn-outline-primary .rounded-pill .px-4}
:::
...
::: {layout-ncol=1}
[📥 Download SSIS Project Archive (.zip)](nyc_taxi_ssis.zip){.btn .btn-outline-primary .rounded-pill .px-4}
:::
...
::: {layout-ncol=1}
[📥 Download SSRS Project Archive (.zip)](nyc_taxi_ssrs.zip){.btn .btn-outline-primary .rounded-pill .px-4}
:::
...
[📄 Download Analysis Report (PDF)](nyc_taxi_dw.pdf){.btn .btn-outline-primary .rounded-pill .px-4}
[📥 Download Tableau Workbook (.twbx)](nyc_taxi_analytics.twbx){.btn .btn-outline-primary .rounded-pill .px-4}