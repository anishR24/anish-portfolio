...
[<i class="bi bi-github"></i> View on GitHub](https://github.com/anishR24/machine-learning-and-pattern-recognition/tree/main/CA2){target="_blank" .btn .btn-outline-dark .btn-sm} [<i class="bi bi-google"></i> Open in Colab](https://colab.research.google.com/drive/1E4ATUk2mBCizDGUXYAOVS_rvqgPPxbFe?usp=sharing){target="_blank" .btn .btn-outline-primary .btn-sm} [<i class="bi bi-database"></i> Dataset](https://github.com/numenta/NAB){target="_blank" .btn .btn-outline-info .btn-sm}
...
[<i class="bi bi-file-earmark-pdf"></i> Download Final Report](anomaly.pdf){target="_blank" .btn .btn-primary .btn-lg role="button"}
:::
...
::: {.d-grid .gap-2 .col-6 .mx-auto}
[<i class="bi bi-file-earmark-pdf"></i> Download Final Report](anomaly.pdf){target="_blank" .btn .btn-outline-primary .rounded-pill .px-4}
:::