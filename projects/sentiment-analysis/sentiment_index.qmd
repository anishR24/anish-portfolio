...
[<i class="bi bi-github"></i> View on GitHub](https://github.com/anishR24/programming-for-data-analysis/tree/main/CA2){target="_blank" .btn .btn-outline-dark .btn-sm} 
...
[<i class="bi bi-database"></i> Dataset](https://www.kaggle.com/datasets/lakshmi25npathi/imdb-dataset-of-50k-movie-reviews){target="_blank" .btn .btn-outline-info .btn-sm}
